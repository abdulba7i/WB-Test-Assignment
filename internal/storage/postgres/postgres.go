...
func (s *Storage) GetOrdersBatch(ctx context.Context, batchSize int, processBatch func([]Order) error) error {
...
func (s *Storage) getItemsForOrder(ctx context.Context, orderUID string) ([]Item, error) {
	query := `
